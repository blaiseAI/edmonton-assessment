...
templates['property'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<section class=\"details\">\n    <h3>Details</h3>\n    <ul>\n        <li>neighbourhood - "
    ...
    + alias4((lookupProperty(helpers,"currency")||(depth0 && lookupProperty(depth0,"currency"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"total_asmt") : depth0),{"name":"currency","hash":{},"data":data,"loc":{"start":{"line":6,"column":20},"end":{"line":6,"column":45}}}))
    + "</li>\n        <li>Garage   "
    ...
    + "</li>\n        <li>Longitude  "
    + alias4(((helper = (helper = lookupProperty(helpers,"longitude") || (depth0 != null ? lookupProperty(depth0,"longitude") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"longitude","hash":{},"data":data,"loc":{"start":{"line":9,"column":23},"end":{"line":9,"column":36}}}) : helper)))
    + "</li>\n    </ul>\n</section>";
},"useData":true});
})();